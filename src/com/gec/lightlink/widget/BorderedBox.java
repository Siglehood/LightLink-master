...
public class BorderedBox extends Drawable {
	...
	public void setBorderRadius(float r) {
		mRadius = r;
	}

	public void setShadowOffset(PointF p) {
		mShadowOffset = p;
	}
	...
	public void setColor(int color) {
		mCenter.setColor(color);
	}

	public void setShader(Shader shader) {
		mCenter.setShader(shader);
	}
	...
	public void setShadowShader(Shader shader) {
		mShadowPaint.setShader(shader);
	}

	public void setShadowInset(boolean inset) {
		mShadowInset = inset;
	}
}
